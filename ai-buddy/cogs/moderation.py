...
class Moderation(commands.Cog):
    ...
    @app_commands.command(name="kick", description="Cuenta las veces que un usuario ha desconectado a otro de un canal de voz")
    @app_commands.describe(moderador="Quien ejecutó la desconexión", usuario="Quien fue desconectado")
    async def kick(self, interaction: discord.Interaction, moderador: discord.User, usuario: discord.User):
